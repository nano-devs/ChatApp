...
namespace NET5ChatAppServerAPI.Controllers
{
	public class GroupsController : BaseApiController
	{
		...
		/// <returns></returns>
		[HttpGet]
		public async Task<string> GetGroupMember(Guid groupId)
		{
			var group = await this.Details(groupId);
			return ((Groups)group).MemberIds;
		}
		...
		/// <returns></returns>
		[HttpPost]
		public async Task<object> AddMember(Guid groupId, Guid userpId)
		{
			return null;
		}
		...
		/// <returns></returns>
		[HttpPost]
		public async Task<object> RemoveMember(Guid groupId, Guid userpId)
		{
